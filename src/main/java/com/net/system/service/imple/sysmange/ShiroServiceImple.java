...
public class ShiroServiceImple implements ShiroService{
    ...
    private static final Logger log = LoggerFactory.getLogger(ShiroServiceImple.class);
    ...
    public Map<String, String> getUrlPermsMap() {
        ...
        filterChainDefinitionMap.put("/loginNoVerify", "anon");
        ...
        filterChainDefinitionMap.put("/zhyg_image/*", "anon");
