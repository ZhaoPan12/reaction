...
import com.net.common.shiro.EnhanceModularRealmAuthenticator;
import com.net.common.shiro.OAuth2Helper;
import com.net.common.shiro.RestShiroFilterFactoryBean;
import com.net.common.shiro.ShiroActionProperties;
import com.net.common.shiro.credential.RetryLimitHashedCredentialsMatcher;
import com.net.common.shiro.filter.OAuth2AuthenticationFilter;
import com.net.common.shiro.filter.RestAuthorizationFilter;
import com.net.common.shiro.filter.RestFormAuthenticationFilter;
import com.net.common.shiro.realm.OAuth2GiteeRealm;
import com.net.common.shiro.realm.OAuth2GithubRealm;
import com.net.common.shiro.realm.UserNameRealm;
