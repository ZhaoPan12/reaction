...
import com.net.common.exception.TreeCastException;
...
public class TreeUtil {
    ...
    public static List<Menu> getMenu(String webName,List<Menu> list){
    	for (Menu menu : list) {
    	   menu.setUrl(webName+menu.getUrl());
    	   if(menu.getChildren()!=null&&menu.getChildren().size()>0) {
    		   menu.setChildren(getMenu(webName,menu.getChildren())); 
    	   }
    	}
		return list;
    }
